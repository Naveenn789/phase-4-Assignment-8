    ...
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var publisher = await _context.Publishers
                .FirstOrDefaultAsync(m => m.Pname == id);
            if (publisher == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Pid,Pname,Paddress")] Publisher publisher)
        {
            if (id != publisher.Pname)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!PublisherExists(publisher.Pname))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.Publishers?.Any(e => e.Pname == id)).GetValueOrDefault();
        }
    }
}
